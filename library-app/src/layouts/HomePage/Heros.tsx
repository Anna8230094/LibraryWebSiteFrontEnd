          ...
          <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
            <div className="ml-2">
              ...
              <p>
                ...
                Whethere it is to learn a new skill or grow within one, we will
        ...
        <div className="row g-0">
          <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
            <div className="ml-2">
              ...
              <p className="lead">
                Try too check in daily as our collection is always changing! We
                work not stop to provide the more accurate books selection
